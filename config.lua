...
Config.ItemMapping = {
    ...
    ["clothing_bottom"] = { "pants", "boots", "spats", "chaps", "stockings", "boot_accessories", "pants_accessories" },
    ["clothing_torso"] = { "shirts_full", "vests", "coats", "ponchos", "cloaks", "gloves" },
    ["clothing_access"] = { "neckwear", "jewelry_rings", "jewelry_bracelets", "jewelry_necklaces", "gunbelts", "belts", "buckles" },
    -- "clothing_all" nebo jakýkoliv jiný item, který tu není, bude brát VŠE, co má hráč na sobě.
}

-- Definice itemů, které spouští logiku oblečení (aby script věděl, že má reagovat)
Config.ClothingItems = {
    "clothing_hat",
    "clothing_bottom",
    "clothing_torso",
    "clothing_access",
    "clothing_all" -- Příklad itemu pro celý outfit
}
